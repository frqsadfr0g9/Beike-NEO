      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            FilledButton.tonal(onPressed: _refreshExams, child: const Text('重试')),
          ],
        ),
      );
    }
    ...
    if (_allExams == null) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.assignment, size: 64, color: Theme.of(context).colorScheme.onSurfaceVariant),
            SizedBox(height: 16),
            Text('暂无考试数据', style: TextStyle(fontSize: 18, color: Theme.of(context).colorScheme.onSurfaceVariant)),
          ],
        ),
      );
    }
